...
# Change Knit directory to Project directory (default: Document directory)
...
my_date <- my(my_date)  #function my from package lubridate --> month-year
head(my_date)
...
# need to exclude datetime column from this conversion
# frequency of 12 helps calculate the seasonality in the data, which is at a monthly level
...
#Ideally, acf should decay with time, but this data has strong seasonality component that is shown by swaying acf
#lag=12 shows the relation between today and 12 months ago
#Capital Acf fn shows the entire plot in the box..out till the last lag
